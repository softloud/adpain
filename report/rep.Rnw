...
include_graphics("img/pain_sub-duloxetine-condition-neuropathic-forest.png")
include_graphics("img/pain_sub-duloxetine-condition-neuropathic-funnel.png")
@
...
include_graphics("img/pain_sub-duloxetine-condition-fibromyalgia-forest.png")
include_graphics("img/pain_sub-duloxetine-condition-fibromyalgia-funnel.png")
@
...
include_graphics("img/pain_sub-milnacipran-condition-fibromyalgia-forest.png")
include_graphics("img/pain_sub-milnacipran-condition-fibromyalgia-funnel.png")
@
...
include_graphics("img/pain_sub-duloxetine-dose-high-forest.png")
include_graphics("img/pain_sub-duloxetine-dose-high-funnel.png")
@
...
include_graphics("img/pain_sub-duloxetine-dose-standard-forest.png")
include_graphics("img/pain_sub-duloxetine-dose-standard-funnel.png")
@
...
include_graphics("img/pain_sub-duloxetine-dose-low-forest.png")
include_graphics("img/pain_sub-duloxetine-dose-low-funnel.png")
@
...
include_graphics("img/pain_sub-duloxetine-rob-high-forest.png")
include_graphics("img/pain_sub-duloxetine-rob-high-funnel.png")
@
...
include_graphics("img/pain_sub-duloxetine-rob-low-forest.png")
include_graphics("img/pain_sub-duloxetine-rob-low-funnel.png")
@
...
<<>>=
include_graphics("img/mood-change_score-duloxetine- - -forest.png")
include_graphics("img/mood-change_score-duloxetine- - -funnel.png")
...
<<>>=
include_graphics("img/adverse-duloxetine- - -forest.png")
include_graphics("img/adverse-duloxetine- - -funnel.png")
...
Meta-analysis comparing duloxetine to placebo produces the same results as for substantial pain (see Figure \ref{fig:painsub-dulox-plac}); i.e., consistent, precise, in keeping with the network meta-analysis results, but some indication of publication bias (not significant).
