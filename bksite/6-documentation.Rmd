...
The assumed direction of improvement for each outcome is encoded in `direction_of_improvement`. For standardised mean difference `smd` outcomes, where the scale reported was opposite to the assumed direction, the mean was set to `-mean`.
